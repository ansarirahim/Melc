...
#define NO_OF_COL 44
#include <stdint.h>
#define FILENAME "/root/Melc/Flash.HEX"
...
int main(int argc, char *argv[])
{
	...
	//File to be loaded.	
//	FILE *hex_file;
printf("\nline=%d",countlines("/root/Melc/Flash.HEX"));
	//Open file using command-line info; for reading.
	//hex_file = open_file ("/root/Melc/Flash.HEX", "rb" );
hex_file=fopen("/root/Melc/Flash.HEX","r");
printf("\nFile is opened");
